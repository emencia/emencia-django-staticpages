...
emencia-django-staticpages is developed with:
...
type: ::
    ...
    git clone https://github.com/emencia/emencia-django-staticpages.git
    cd emencia-django-staticpages
    make install

emencia-django-staticpages will be installed in editable mode from the
